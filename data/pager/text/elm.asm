...
ElmPagerDiscoveredHatchTimeText:
	text "Hello, <PLAY_G>?"
...
ElmPagerInvestigatingEggMovesText:
	text "Hello, <PLAY_G>?"
...
ElmPagerRadioTowerRocketTakeoverText:
	text "<PLAY_G>, how are"
	line "things going?"
...
ElmPagerGotAholdOfSomethingNeatText:
	text "Hello, <PLAY_G>?"
	line "How's it going?"
