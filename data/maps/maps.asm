...
MapGroup_Cerulean:
	...
	map CeruleanGymBadgeSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanBerrySpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanBikeShop, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanGym, TILESET_GYM_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_NONE
