...
MapGroup_Dungeons:
	...
	map DiglettsCaveRoute2, TILESET_CAVE, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map DiglettsCaveRoute11, TILESET_CAVE, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
