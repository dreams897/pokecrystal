...
MapGroup_Dungeons:
	...
	map DiglettsCave, TILESET_CAVE_KANTO, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map DiglettsCaveRoute2, TILESET_CAVE_KANTO, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map DiglettsCaveRoute11, TILESET_CAVE_KANTO, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Vermilion:
	...
	map VermilionFishingSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map PokemonFanClub, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionMagnetTrainSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionMart, TILESET_MART_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionDiglettsCaveSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route6UndergroundPathEntrance, TILESET_GATE, GATE, LANDMARK_ROUTE_6, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterSnoozeSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_FastShip:
	...
	map VermilionDock, TILESET_PORT, ROUTE, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map SSAnne1F, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2F, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne3F, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneB1F, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneBow, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneKitchen, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneCaptainsRoom, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne1FRooms, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2FRooms, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneB1FRooms, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map ViridianNicknameSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrainerHouse1F, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ViridianForest, TILESET_VIRIDIAN_FOREST, FOREST, LANDMARK_VIRIDIAN_FOREST, MUSIC_DUNGEON3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map Route5UndergroundPathEntrance, TILESET_GATE, GATE, LANDMARK_ROUTE_5, MUSIC_ROUTES3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
