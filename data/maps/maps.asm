...
MapGroup_Viridian:
	...
	map ViridianForestNorthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ViridianForestSouthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_CITIES1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForest, TILESET_VIRIDIAN_FOREST, CAVE, LANDMARK_VIRIDIAN_FOREST, MUSIC_DUNGEON3, FALSE, PALETTE_NITE, FISHGROUP_SHORE
