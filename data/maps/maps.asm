...
MapGroup_FastShip:
	...
	map SSAnne1F, TILESET_SHIP_KANTO, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2F, TILESET_SHIP_KANTO, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne3F, TILESET_SHIP_KANTO, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneB1F, TILESET_SHIP_KANTO, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneBow, TILESET_SHIP_KANTO, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneKitchen, TILESET_SHIP_KANTO, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneCaptainsRoom, TILESET_SHIP_KANTO, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne1FRooms, TILESET_SHIP_KANTO, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2FRooms, TILESET_SHIP_KANTO, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneB1FRooms, TILESET_SHIP_KANTO, INDOOR, LANDMARK_FAST_SHIP, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
