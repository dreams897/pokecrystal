...
; SPRITE_ANIM_OBJ_CELEBI
	...
	db SPRITE_ANIM_FRAMESET_GREEN_WALK,                SPRITE_ANIM_FUNC_NULL,                      SPRITE_ANIM_DICT_DEFAULT ; SPRITE_ANIM_INDEX_GREEN_WALK
	db SPRITE_ANIM_FRAMESET_MAGNET_TRAIN_GREEN,        SPRITE_ANIM_FUNC_NULL,                      SPRITE_ANIM_DICT_DEFAULT ; SPRITE_ANIM_INDEX_MAGNET_TRAIN_GREEN
; ENBY
	db SPRITE_ANIM_FRAMESET_PURPLE_WALK,               SPRITE_ANIM_FUNC_NULL,                      SPRITE_ANIM_DICT_DEFAULT ; SPRITE_ANIM_INDEX_PURPLE_WALK
	db SPRITE_ANIM_FRAMESET_MAGNET_TRAIN_PURPLE,       SPRITE_ANIM_FUNC_NULL,                      SPRITE_ANIM_DICT_DEFAULT ; SPRITE_ANIM_INDEX_MAGNET_TRAIN_PURPLE
