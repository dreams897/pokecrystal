...
; entries correspond to ENGINE_* constants
	...
	engine_flag wDailyPagerItemFlags, 0 ; beverly has nugget
	engine_flag wDailyPagerItemFlags, 1 ; jose has star piece
	engine_flag wDailyPagerItemFlags, 2 ; wade has item (see EVENT_WADE_HAS_*** in constants/event_flags.asm)
	engine_flag wDailyPagerItemFlags, 3 ; gina has leaf stone
	engine_flag wDailyPagerItemFlags, 4 ; alan has fire stone
	engine_flag wDailyPagerItemFlags, 5 ; liz has thunderstone
	engine_flag wDailyPagerItemFlags, 6 ; derek has nugget
	engine_flag wDailyPagerItemFlags, 7 ; tully has water stone
	engine_flag wDailyPagerItemFlags, 8 ; tiffany has pink bow
	engine_flag wDailyPagerItemFlags, 9 ; wilton has item (see EVENT_WILTON_HAS_*** in constants/event_flags.asm)

	engine_flag wDailyPagerTimeOfDayFlags,  0 ; jack
	engine_flag wDailyPagerTimeOfDayFlags,  1 ; huey
	engine_flag wDailyPagerTimeOfDayFlags,  2 ; gaven
	engine_flag wDailyPagerTimeOfDayFlags,  3 ; beth
	engine_flag wDailyPagerTimeOfDayFlags,  4 ; jose
	engine_flag wDailyPagerTimeOfDayFlags,  5 ; reena
	engine_flag wDailyPagerTimeOfDayFlags,  6 ; joey
	engine_flag wDailyPagerTimeOfDayFlags,  7 ; wade
	engine_flag wDailyPagerTimeOfDayFlags,  8 ; ralph
	engine_flag wDailyPagerTimeOfDayFlags,  9 ; liz
	engine_flag wDailyPagerTimeOfDayFlags, 10 ; anthony
	engine_flag wDailyPagerTimeOfDayFlags, 11 ; todd
	engine_flag wDailyPagerTimeOfDayFlags, 12 ; gina
	engine_flag wDailyPagerTimeOfDayFlags, 13 ; arnie
	engine_flag wDailyPagerTimeOfDayFlags, 14 ; alan
	engine_flag wDailyPagerTimeOfDayFlags, 15 ; dana
	engine_flag wDailyPagerTimeOfDayFlags, 16 ; chad
	engine_flag wDailyPagerTimeOfDayFlags, 17 ; tully
	engine_flag wDailyPagerTimeOfDayFlags, 18 ; brent
	engine_flag wDailyPagerTimeOfDayFlags, 19 ; tiffany
	engine_flag wDailyPagerTimeOfDayFlags, 20 ; vance
	engine_flag wDailyPagerTimeOfDayFlags, 21 ; wilton
	engine_flag wDailyPagerTimeOfDayFlags, 22 ; parry
	engine_flag wDailyPagerTimeOfDayFlags, 23 ; erin
