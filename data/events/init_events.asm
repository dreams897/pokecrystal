InitialEvents:
	...
	dw EVENT_OAK_APPEARED_IN_PALLET
	dw EVENT_GAMBLER_AWAKE
	dw EVENT_ROUTE22_RIVAL_WANTS_BATTLE
	dw EVENT_TEAM_ROCKET_APPEARED_MT_MOON
	dw EVENT_TEAM_ROCKET_APPEARED_CELADON_CITY
	dw EVENT_TEAM_ROCKET_APPEARED_LAVENDER_TOWN
	dw EVENT_TEAM_ROCKET_APPEARED_SAFFRON
	dw EVENT_CERULEAN_RIVAL_WANTS_BATTLE
...
ENDM
	...
	initvarsprite SPRITE_OAK_BLUE, SPRITE_OAK
	initvarsprite SPRITE_BILL_MON, SPRITE_MONSTER
	db -1 ; end
