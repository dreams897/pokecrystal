InitialEvents:
	...
	dw EVENT_FOLLOWED_OAK_INTO_LAB
	dw EVENT_GOT_A_POKEMON_FROM_OAK
	dw EVENT_GOT_A_CHARMANDER_FROM_OAK
	dw EVENT_GOT_A_SQUIRTLE_FROM_OAK
	dw EVENT_GOT_A_BULBASAUR_FROM_OAK
