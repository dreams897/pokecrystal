...
Route11_MapEvents:
	...
	warp_event  4,  5, DIGLETTS_CAVE_ROUTE_11, 3
	...
	def_object_events
	object_event 22, 12, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerYoungsterOwen, -1
