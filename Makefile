roms := \
	PokeRedRemastered.gbc \
	PokeRedRemastered11.gbc \
	PokeRedRemastered_au.gbc \
	PokeRedRemastered_debug.gbc \
	PokeRedRemastered11_debug.gbc
patches := PokeRedRemastered11.patch
...
PokeRedRemastered_obj         := $(rom_obj:.o=.o)
PokeRedRemastered11_obj       := $(rom_obj:.o=11.o)
PokeRedRemastered_au_obj      := $(rom_obj:.o=_au.o)
PokeRedRemastered_debug_obj   := $(rom_obj:.o=_debug.o)
PokeRedRemastered11_debug_obj := $(rom_obj:.o=11_debug.o)
PokeRedRemastered11_vc_obj    := $(rom_obj:.o=11_vc.o)
...
.SUFFIXES:
.PHONY: all red_re red_re11 red_re_au red_re_debug red_re11_debug clean tidy compare tools
.SECONDEXPANSION:
.PRECIOUS:
.SECONDARY:

all: red_re
red_re:         PokeRedRemastered.gbc
red_re11:       PokeRedRemastered11.gbc
red_re_au:      PokeRedRemastered_au.gbc
red_re_debug:   PokeRedRemastered_debug.gbc
red_re11_debug: PokeRedRemastered11_debug.gbc
red_re11_vc:    PokeRedRemastered11.patch
...
tidy:
	$(RM) $(roms) \
	      ...
	      $(PokeRedRemastered_obj) \
	      $(PokeRedRemastered11_obj) \
	      $(PokeRedRemastered11_vc_obj) \
	      $(PokeRedRemastered_au_obj) \
	      $(PokeRedRemastered_debug_obj) \
	      $(PokeRedRemastered11_debug_obj) \
	      rgbdscheck.o
	$(MAKE) clean -C tools/
...
$(PokeRedRemastered_obj):         RGBASMFLAGS +=
$(PokeRedRemastered11_obj):       RGBASMFLAGS += -D _CRYSTAL11
$(PokeRedRemastered_au_obj):      RGBASMFLAGS += -D _CRYSTAL11 -D _CRYSTAL_AU
$(PokeRedRemastered_debug_obj):   RGBASMFLAGS += -D _DEBUG
$(PokeRedRemastered11_debug_obj): RGBASMFLAGS += -D _CRYSTAL11 -D _DEBUG
$(PokeRedRemastered11_vc_obj):    RGBASMFLAGS += -D _CRYSTAL11 -D _CRYSTAL11_VC
...
$(foreach obj, $(PokeRedRemastered_obj), $(eval $(call DEP,$(obj),$(obj:.o=.asm))))
$(foreach obj, $(PokeRedRemastered11_obj), $(eval $(call DEP,$(obj),$(obj:11.o=.asm))))
$(foreach obj, $(PokeRedRemastered_au_obj), $(eval $(call DEP,$(obj),$(obj:_au.o=.asm))))
$(foreach obj, $(PokeRedRemastered_debug_obj), $(eval $(call DEP,$(obj),$(obj:_debug.o=.asm))))
$(foreach obj, $(PokeRedRemastered11_debug_obj), $(eval $(call DEP,$(obj),$(obj:11_debug.o=.asm))))
$(foreach obj, $(PokeRedRemastered11_vc_obj), $(eval $(call DEP,$(obj),$(obj:11_vc.o=.asm))))
...
PokeRedRemastered_opt         = -Cjv -t RED_RE -i BYTE -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
PokeRedRemastered11_opt       = -Cjv -t RED_RE -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
PokeRedRemastered_au_opt      = -Cjv -t RED_RE -i BYTU -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
PokeRedRemastered_debug_opt   = -Cjv -t RED_RE -i BYTE -n 0 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
PokeRedRemastered11_debug_opt = -Cjv -t RED_RE -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
PokeRedRemastered11_vc_opt    = -Cjv -t RED_RE -i BYTE -n 1 -k 01 -l 0x33 -m 0x10 -r 3 -p 0
...
gfx/title/red_re.2bpp: tools/gfx += --interleave --png=$<
...
gfx/trainer_card/green_card.2bpp: rgbgfx += -Z
...
gfx/mobile/pager_tiles.2bpp: tools/gfx += --remove-whitespace
