...
; entries correspond to TX_* constants (see macros/scripts/text.asm)
	...
	dw TextCommand_SOUND         ; TX_LEVEL_UP_RBY
...
TextSFX::
	dbw TX_SOUND_LEVEL_UP_RBY,       SFX_LEVEL_UP_RBY
	dbw TX_SOUND_FANFARE,            SFX_DEX_PAGE_ADDED
	dbw TX_SOUND_DEX_FANFARE_20_49,  SFX_DEX_FANFARE_20_49
	dbw TX_SOUND_ITEM,               SFX_GET_ITEM1_1
	dbw TX_SOUND_CAUGHT_MON,         SFX_CAUGHT_MON_RBY
	dbw TX_SOUND_DEX_FANFARE_80_109, SFX_CAUGHT_MON_RBY
	dbw TX_SOUND_SLOT_MACHINE_START, SFX_SLOTS_NEW_SPIN
	db -1
